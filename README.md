...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-socks-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-socks-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-socks
# for installing globally
pixi global install python-socks
```
...
It is possible to list all of the versions of `python-socks` available on your platform:
...
```
pixi search python-socks --channel conda-forge
```
